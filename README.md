...
Milestones 1–24: a working relational store, queryable in SQL — in
...
aggregate), descending index columns, EXPLAIN, and
...
- [ ] Later: order-aware path selection among redundant indexes, window frames (`ROWS/RANGE BETWEEN`), standalone `CREATE SEQUENCE`
